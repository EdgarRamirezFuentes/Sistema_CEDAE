...
\begin{document}
    ...
    \section{Diagramas y especificación de casos de uso}
        \subsection{Diagramas del modulo de gestión de usuarios}
            ...
            \begin{figure}[H]
                \centering
                \includegraphics [scale=0.3]{casosUso/cambiarContraseña}
                \caption{Diagrama de cambio de contraseña}
            \end{figure}
            \begin{figure}[H]
                \centering
                \includegraphics [scale=0.75]{specs/specCambiarContraseña}
            \end{figure}
            \begin{figure}[H]
                \centering
                \includegraphics [scale=0.75]{specs/trayCambiarContraseña}
            \end{figure}
